...
- `@revolist/revogrid-pro` → `@revolist/rv-pro-trial@2.7.13`
- `@revolist/pivot` → `@revolist/pivot-trial@2.7.13`
- `@revolist/gantt` → `@revolist/gantt-trial@2.7.13`
- `@revolist/scheduler` → `@revolist/scheduler-trial@2.7.13`
